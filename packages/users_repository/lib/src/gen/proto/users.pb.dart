...
class LoginUserRequest extends $pb.GeneratedMessage {
  ...
  LoginUserRequest copyWith(void Function(LoginUserRequest) updates) =>
      super.copyWith((message) => updates(message as LoginUserRequest))
          as LoginUserRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LoginUserResponse extends $pb.GeneratedMessage {
  ...
  LoginUserResponse copyWith(void Function(LoginUserResponse) updates) =>
      super.copyWith((message) => updates(message as LoginUserResponse))
          as LoginUserResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LogoutUserRequest extends $pb.GeneratedMessage {
  ...
  factory LogoutUserRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LogoutUserRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LogoutUserRequest copyWith(void Function(LogoutUserRequest) updates) =>
      super.copyWith((message) => updates(message as LogoutUserRequest))
          as LogoutUserRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static LogoutUserRequest create() => LogoutUserRequest._();
  LogoutUserRequest createEmptyInstance() => create();
  static $pb.PbList<LogoutUserRequest> createRepeated() =>
      $pb.PbList<LogoutUserRequest>();
  @$core.pragma('dart2js:noInline')
  static LogoutUserRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LogoutUserRequest>(create);
...
class LogoutUserResponse extends $pb.GeneratedMessage {
  ...
  factory LogoutUserResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LogoutUserResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LogoutUserResponse copyWith(void Function(LogoutUserResponse) updates) =>
      super.copyWith((message) => updates(message as LogoutUserResponse))
          as LogoutUserResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static LogoutUserResponse create() => LogoutUserResponse._();
  LogoutUserResponse createEmptyInstance() => create();
  static $pb.PbList<LogoutUserResponse> createRepeated() =>
      $pb.PbList<LogoutUserResponse>();
  @$core.pragma('dart2js:noInline')
  static LogoutUserResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LogoutUserResponse>(create);
